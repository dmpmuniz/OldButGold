...
def test_build_result_failed_returns_failed_classification():
    ...
    result = _build_result(False, False, steps, info, None, None, None, 0, time.monotonic(), None)
...
def test_build_result_cancelled_returns_failed_classification():
    ...
    result = _build_result(False, True, steps, info, None, None, None, 0, time.monotonic(), None)
    assert result.success is False
